...
TRANSLATIONS = {
    "en": {
        ...
        "welcome_intro": "Welcome to CheZZ! Play chess with your friends or vs computer right here in Telegram.",
    ...
    "ru": {
        ...
        "welcome_intro": "Добро пожаловать в CheZZ! Играйте в шахматы с друзьями или с компьютером прямо в Telegram.",
