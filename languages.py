...
TRANSLATIONS = {
    "en": {
        ...
        "welcome_join": "/join [code] - Join a game",
        "welcome_current_game": "/current_game - Show your current game",
        "welcome_leave": "/leave - Leave current game (forfeit)",
    ...
    "ru": {
        ...
        "welcome_join": "/join [код] - Присоединиться к игре",
        "welcome_current_game": "/current_game - Показать текущую игру",
        "welcome_leave": "/leave - Покинуть текущую игру (сдаться)",
